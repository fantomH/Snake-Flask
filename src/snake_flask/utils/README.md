...
| **!** | This function is part of the `snake_flask` root API, thus we suggest using:<br><br>`from snake_flask import get_client_ip`<br><br>This avoids code breaking upon `snake_flask.utils` structural changes. |
| :---: | :------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
